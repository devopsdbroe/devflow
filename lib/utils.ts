...
export const formUrlQuery = ({ params, key, value }: UrlQueryParams) => {
	// Check url for queries, filters, etc.
	const currentUrl = qs.parse(params);

	// Only update the one we want to update
...
export const assignBadges = (params: BadgeProps) => {
...
export function processJobTitle(title: string | undefined | null): string {
	...
	// Joine the valid words to create the processed title
